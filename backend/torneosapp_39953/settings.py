"""
Django settings for torneosapp_39953 project.
...
ROOT_URLCONF = 'torneosapp_39953.urls'
...
WSGI_APPLICATION = 'torneosapp_39953.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "torneosapp_39953 API",
    "DESCRIPTION": "API documentation for torneosapp_39953 App",
    "VERSION": "v1",
}
